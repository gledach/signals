...
import { COMPANIES, COMPETITOR_IDS, getCompany } from '../config/companies.mjs';
...
import { getTranscript, saveTranscript, truncateForClassifier } from '../pipeline/transcript.mjs';
import { fetchChannelUploads } from './adapters/youtube-channel.mjs';
